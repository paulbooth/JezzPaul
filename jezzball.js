...
var bonusRoundMobileAllowed = [true,  true,         true,          false,         true,      false];
...
function tryBonusRound() {
  if (!isBonusRound) {
    ...
    } while (useTouch() && !bonusRoundMobileAllowed[bonusRoundType])
    makeBonusRound();
  } else {
...
function getRandomTip() {
  var tips = ['For the love of cats, share this with your friends. And enemies.',
    ...
    'If you share on Facebook, your lines grow faster.',
    'It is significantly easier to split up the balls into different boxes.',
    'JezzPaul loves you more than your significant other.',
